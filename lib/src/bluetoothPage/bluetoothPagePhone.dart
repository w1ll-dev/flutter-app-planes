...
import 'package:levelApp/src/planesPage/planesPagePhone.dart';

class BluetoothPagePhone extends StatefulWidget {
  @override
  _BluetoothPagePhoneState createState() => _BluetoothPagePhoneState();
}

class _BluetoothPagePhoneState extends State<BluetoothPagePhone> {
          ...
          child: Column(
            ...
            children: <Widget>[
              Padding(
                ...
                child: Text(
                  "PAIRED DEVICES",
                  style: TextStyle(fontSize: 24, color: Colors.black, fontFamily: 'Quebec Black',),
              ...
              RaisedButton(
                onPressed: () => Navigator.push(
                  ...
                  //data entrance before this

                  MaterialPageRoute(builder: (context) => PlanesPagePhone())),
